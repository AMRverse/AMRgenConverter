  ...
  navset_card_tab(
    ...
    nav_panel(
      ...
      div(
        ...
        tags$ol(
          tags$li(HTML('Upload your antibiogram file in a supported format. Click the "Input format" selector to see the list of supported input formats. Instructions on exporting bulk antibiogram data from instruments like Vitek and Sensititre can be found <a href=\"https://esgem-amr.amrrules.org/export-ast\" target=\"_blank\" rel=\"noopener noreferrer\">here</a>.')),
